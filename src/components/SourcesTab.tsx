            ...
            <div className="space-y-2 max-h-52 overflow-y-auto pr-1">
              {presetSources.map((preset, idx) => (
                <button
                  ...
                  className="w-full text-right bg-gray-50 hover:bg-orange-50/70 border border-gray-200/90 hover:border-orange-200 p-2.5 rounded-xl text-xs text-gray-700 flex items-center justify-between transition-all min-h-[42px] group"
                >
                  <div className="flex items-center gap-2 min-w-0 pr-1">
                    <span className="font-medium text-gray-900 truncate">{preset.name}</span>
                    <span className="text-[10px] text-sky-700 bg-sky-50 px-2 py-0.5 rounded-md border border-sky-100 shrink-0 font-medium">
                      {preset.label}
                    </span>
                  </div>
                  <span className="text-[11px] font-bold text-orange-600 bg-orange-100/70 group-hover:bg-orange-500 group-hover:text-white px-2.5 py-1 rounded-lg border border-orange-200/80 transition-all shrink-0">
                    انتخاب
                  </span>
                </button>
              ))}
