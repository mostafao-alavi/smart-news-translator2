    ...
    <div className="space-y-4">
      ...
      <div className="bg-white/80 backdrop-blur-md border border-gray-200/90 rounded-2xl p-3 sm:p-4 flex flex-col sm:flex-row items-center justify-between gap-3 shadow-2xs">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto justify-between sm:justify-start">
          <button
            ...
            className="hidden md:flex items-center gap-1.5 bg-gray-100 hover:bg-gray-200 text-gray-700 text-xs font-bold px-3 py-2 rounded-xl border border-gray-200/80 transition-all min-h-[40px]"
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="bg-emerald-50 hover:bg-emerald-100 text-emerald-800 border border-emerald-200 text-xs px-3 py-2 rounded-xl font-bold transition-all flex items-center gap-1.5 min-h-[40px]"
            >
            ...
            <button
              ...
              className="bg-gray-100 hover:bg-gray-200 text-gray-800 border border-gray-200 text-xs px-3 py-2 rounded-xl font-bold transition-all flex items-center gap-1.5 disabled:opacity-50 min-h-[40px]"
            >
            ...
            <button
              ...
              className="bg-orange-500 hover:bg-orange-600 text-white shadow-2xs border border-orange-600 text-xs px-3.5 py-2 rounded-xl font-bold transition-all flex items-center gap-1.5 disabled:opacity-50 min-h-[40px]"
            >
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          <div className="relative flex-1 sm:w-64">
            ...
            <input
              ...
              className="w-full bg-gray-50/80 border border-gray-200/90 text-gray-900 placeholder-gray-400 rounded-xl pr-9 pl-3 py-2 text-xs focus:outline-none focus:border-orange-500 focus:bg-white"
            />
          </div>
        ...
        <div className="bg-emerald-50/60 border border-emerald-200 rounded-2xl p-4 sm:p-5 space-y-4 shadow-xs animate-in fade-in">
          ...
          <form onSubmit={handleCustomSubmit} className="space-y-3">
            ...
            <button
              ...
              className="bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs px-5 py-2.5 rounded-xl transition-colors flex items-center space-x-1.5 space-x-reverse disabled:opacity-50"
            >
              {isSubmittingCustom ? (
                <>
      ...
      <div className="bg-white border border-gray-200/90 rounded-2xl shadow-sm overflow-hidden flex flex-col md:flex-row h-[calc(100vh-220px)] min-h-[550px]">
        ...
        <div
          ...
          } ${mobileShowDetail ? 'hidden md:block' : 'block'} w-full border-l border-gray-200 bg-gray-50/70 flex flex-col shrink-0`}
        >
          {/* Master List Header */}
          <div className="p-3 bg-white border-b border-gray-200 flex items-center justify-between text-xs text-gray-500 font-bold">
            <span className="flex items-center gap-1.5 text-gray-700">
              <Columns className="w-4 h-4 text-orange-500" />
              <span>فهرست اخبار ({filteredNews.length})</span>
            </span>
              ...
              filteredNews.map((item) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full text-right p-3 rounded-xl transition-all block space-y-1.5 relative ${
                      isSelected
              ...
              <div className="p-3 sm:p-4 bg-white/90 backdrop-blur-md border-b border-gray-200/90 flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-3 shrink-0 shadow-2xs z-10">
                ...
                <div className="flex items-center justify-between lg:justify-start gap-2.5">
                  ...
                  <button
                    ...
                    className="md:hidden flex items-center gap-1 bg-white hover:bg-gray-100 border border-gray-200 text-xs font-bold text-gray-700 px-3 py-1.5 rounded-xl shadow-2xs"
                  >
                  ...
                  <div className="flex items-center gap-2">
                    <span className="bg-orange-50 text-orange-700 border border-orange-200/90 text-xs font-bold px-3 py-1 rounded-xl flex items-center gap-1.5 shadow-2xs">
                      <Globe className="w-3.5 h-3.5 text-orange-600" />
                      {selectedArticle.source_name}
                    </span>

                    <span className="text-[11px] text-gray-500 font-medium hidden sm:inline-flex items-center gap-1 bg-gray-100/80 px-2.5 py-1 rounded-lg border border-gray-200/60">
                ...
                <div className="flex items-center justify-center bg-gray-200/70 p-1 rounded-xl border border-gray-300/50 self-center">
                  <button
                ...
                <div className="flex items-center justify-end gap-2 shrink-0">
                  <button
                    ...
                    className="bg-indigo-50 hover:bg-indigo-100 text-indigo-700 border border-indigo-200 text-xs font-bold px-3 py-1.5 rounded-xl transition-all flex items-center gap-1.5 shadow-2xs"
                  ...
                  <button
                    ...
                    className="bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white shadow-xs text-xs font-bold px-3.5 py-1.5 rounded-xl transition-all flex items-center gap-1.5"
                  >
                  ...
                  <>
                    {selectedArticle.translated_title ? (
                      <div className="bg-white border border-orange-200/90 rounded-3xl p-6 sm:p-8 space-y-5 shadow-xs relative overflow-hidden group">
                        ...
                        <div className="absolute -top-12 -right-12 w-48 h-48 bg-orange-100/50 rounded-full blur-2xl pointer-events-none" />

                        {/* Card Top Action Bar */}
                        <div className="flex items-center justify-between border-b border-gray-100 pb-3 relative z-10">
                          <div className="flex items-center gap-2">
                            <span className="bg-orange-500 text-white text-[10px] font-bold px-2.5 py-1 rounded-lg flex items-center gap-1 shadow-2xs">
                          ...
                          <div className="flex items-center gap-2">
                            <button
                              ...
                              className="text-xs font-bold text-gray-700 hover:text-orange-700 bg-gray-50 hover:bg-orange-50 border border-gray-200 hover:border-orange-200 px-3 py-1.5 rounded-xl shadow-2xs transition-all flex items-center gap-1.5"
                            >
                        ...
                        {loadingDetailId === selectedArticle.id ? (
                          <div className="py-12 text-center text-xs text-orange-600 flex items-center justify-center gap-2 bg-orange-50/50 rounded-2xl">
                      ...
                      <div className="bg-amber-50/90 border border-amber-200/90 rounded-3xl p-6 text-xs text-amber-900 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-2xs">
                        ...
                        <button
                          onClick={() => setSelectedArticleForTranslate(selectedArticle)}
                          className="bg-orange-500 hover:bg-orange-600 text-white font-bold px-5 py-2.5 rounded-xl text-xs transition-all shadow-md shadow-orange-500/20 shrink-0 flex items-center gap-1.5"
                        >
                  ...
                  <div className="bg-white border border-gray-200/90 rounded-3xl p-6 sm:p-8 space-y-4 shadow-xs">
                    <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                      ...
                      <a
                        ...
                        className="text-xs font-bold text-sky-700 hover:text-sky-900 hover:underline flex items-center gap-1 ltr bg-sky-50 px-3 py-1 rounded-lg border border-sky-200/80 transition-colors"
                      >
          ...
          <div className="bg-white rounded-3xl max-w-lg w-full border border-gray-200 shadow-2xl overflow-hidden p-6 space-y-4">
              ...
              <div className="space-y-2 max-h-60 overflow-y-auto pr-1">
                {AI_MODELS.map((m) => (
                  <button
                    ...
                    className={`w-full text-right p-3 rounded-2xl border transition-all flex items-start justify-between gap-3 ${
                      chosenModel === m.id
            ...
            <div className="flex items-center justify-end gap-2 pt-3 border-t border-gray-100">
              ...
              <button
                ...
                className="bg-orange-500 hover:bg-orange-600 text-white font-bold text-xs px-5 py-2.5 rounded-xl flex items-center gap-1.5 shadow-md shadow-orange-500/20"
              >
                <Sparkles className="w-3.5 h-3.5" />
